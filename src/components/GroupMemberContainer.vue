        ...
        <el-dialog
            ...
            <el-form :model="payInfoForm" label-position="right" label-width="85px">
                ...
                <el-form-item label="捐助金额">
                    <el-input name="money" v-model="payInfoForm.money" placeholder="请输入您想要捐助的金额">
                ...
                <el-form-item label="支付二维码">
                    <div class="QrCodePayment">
                        <div class="empty" v-if="isGenPay===false">
                            <div class="empty-ico">
                                <icon-font icon="icon-u" style="font-size: 4rem"></icon-font>
                            </div>
                            <span>支付二维码待生成</span>
                        </div>
                        <div ref="qrCode" ondragstart='return false;' class="no-select"></div>
                    </div>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer">
                <el-popconfirm
                    ...
                    <el-button type="primary" slot="reference">发起交易(生成支付二维码)</el-button>
                </el-popconfirm>
            </span>
        </el-dialog>
    </div>
...
<script>
    ...
    export default {
        ...
        components: {ContainerTitle, IconFont, SdCard, Carousel},
        mounted() {
